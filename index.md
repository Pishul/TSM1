...
*This index is automatically maintained. Last updated: 2026-07-20T23:02:00+03:30*

## Concepts

- [[eulers-homogeneous-theorem|قضیه همگن اویلر]]
- [[exact-differentials|دیفرانسیل کامل]]
- [[gaussian-integrals|انتگرال‌های گاوسی و گشتاورها]]
- [[partial-derivatives|مشتقات جزئی در ترمودینامیک]]
- [[rubber-band-thermodynamics|ترمودینامیک نوار الاستیک]]
- [[second-law-refrigerator|یخچال در اتاق عایق بسته]]
- [[thermal-contact-equilibrium|انتقال گرما و تعادل در تماس گرمایی]]
- [[carnot-engine|موتور کارنو]]
- [[gas-spring-system|سیستم‌های مکانیکی-ترمودینامیکی مزدوج (گاز و فنر)]]
- [[heat-capacities-difference|تفاوت ظرفیت‌های گرمایی (Cp - Cv)]]
- [[kelvin-statement-paradox|تناقض ظاهری در بیان کلوین از قانون دوم]]
- [[rubber-band-heat-engine|موتور گرمایی نوار الاستیک]]
- [[thermodynamics-in-cosmology|ترمودینامیک در نجوم و کیهان‌شناسی]]
- [[gas-equilibrium-partition|تعادل دو گاز با دیواره متحرک]]
- [[heat-capacity-derivatives|وابستگی ظرفیت‌های گرمایی به متغیرهای حالت]]
- [[legendre-transform-convexity|تبدیل لژاندر و مزدوج محدب]]
- [[maximum-work-extraction|استخراج حداکثر کار (تغییرات آنتروپی اجسام محدود)]]
